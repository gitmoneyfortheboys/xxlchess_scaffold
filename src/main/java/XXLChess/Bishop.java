...
public class Bishop extends Piece {
    ...
    public Bishop(Color color, Square currentSquare, String imgPath) {
        super(PieceType.BISHOP, color, currentSquare, imgPath);
    ...
    public List<Square> calculateLegalMoves(Board board) {
        ...
        // Bishop can move in all 4 diagonal directions, any number of steps at a time
        int[] possibleX = { -1, -1, 1, 1 };
        int[] possibleY = { -1, 1, -1, 1 };
