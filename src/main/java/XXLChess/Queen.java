...
public class Queen extends Piece {
    ...
    public Queen(Color color, Square currentSquare, String imgPath) {
        super(PieceType.QUEEN, color, currentSquare, imgPath);
    ...
    public List<Square> calculateLegalMoves(Board board) {
        ...
        // Queen can move in all 8 directions, any number of steps at a time
